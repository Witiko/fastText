...
class FastText {
 ...
 public:
  ...
  void getWordVector(Vector& vec, const std::string& word, std::minstd_rand&, bool=true) const;

  void getSubwordVector(Vector& vec, const std::string& subword, std::minstd_rand&, bool=true) const;
  ...
  void getSentenceVector(std::istream& in, Vector& vec, std::minstd_rand&, bool=true);
